...
const PRODUCT_PALETTE: Record<string, ColorPair> = {
  ...
  len: { background: "#482049", foreground: "#e1c4ff" },
  "len-4-leg": { background: "#542550", foreground: "#e1c4ff" },
  "len-m": { background: "#5d2c58", foreground: "#e1c4ff" },
  "len-s": { background: "#65345f", foreground: "#e1c4ff" },
